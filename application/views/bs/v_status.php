               ...
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $hasil->h_plas ?></td>
                    <td><?php echo $hasil->h_ker ?></td>
                    <td><?php echo $hasil->h_bes ?></td>
                    ...
                    <td>
                      ...
                      <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="<?php echo base_url() ?>dashboard/c_status/total/<?php echo $hasil->id_smph ?>">Total</a></li>
                          <li><a href="<?php echo base_url() ?>dashboard/c_status/proses/<?php echo $hasil->id_smph ?>">Proses</a></li>
                          <li><a href="<?php echo base_url() ?>dashboard/c_status/selesai/<?php echo $hasil->id_smph ?>">Selesai</a></li>
