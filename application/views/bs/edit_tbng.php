            ...
            <div class="box-body">
              ...
              <form class="form-horizontal" action="<?php echo base_url('dashboard/c_tbng/simpan') ?>" method="POST">
                ...
                <div class="form-group">
                  <label for="saldo" class="col-sm-2 control-label">Nama</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label for="saldo" class="col-sm-2 control-label">Nama</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="nama" name="nama" value="<?php echo $u->saldo ?>" readonly>
                  </div>
                </div>
              <div class="form-group">
              <label for="saldo" class="col-sm-2 control-label">Jumlah Setoran</label>
                  <div class="col-sm-10">
                <input name="setoran" type="text" class="form-control" placeholder="Masukkan Jumlah">
              </div>
            </div>
                <div class="form-group">
