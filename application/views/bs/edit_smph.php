      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="http://localhost/bs/dashboard/c_status"><i class="fa fa-circle-o text-red"></i>Anggota Bank Sampah</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
           ...
           <div class="box">
            ...
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
               ...
               <?php foreach($abs_smph as $u){ ?>
                <div class="tab-content">
                <div class="active tab-pane" id="settings">
                <form class="form-horizontal" action="<?php echo base_url('dashboard/c_status/update') ?>" method="POST">
                    <input type="hidden" name="id_smph" value="<?php echo $u->id_smph ?>">
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Plastik :</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Nama" name="h_plas" value="<?php echo ($u->plas*3000) ?>" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Kertas :</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Nama" name="h_ker" value="<?php echo ($u->ker*3000) ?>"readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Besi :</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Nama" name="h_bes" value="<?php echo ($u->bes*3000) ?>"readonly>
                    </div>
                  </div>
                  <div class="form-group">
