  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo base_url().'dashboard/c_tbng/inputsmph'?>">
        ...
        <li class="active">
          <a href="<?php echo base_url().'dashboard/c_tbng/tbng'?>">
        ...
        <div class="col-xs-12">
           <div class="box">
            <div class="box-header">
              ...
              <p>
              <span><a class="btn btn-success pull-left" style="margin-bottom:2%;" href="http://localhost/bs/dashboard/c_tbng/setoran" >Setoran</a></span>
              <span><a class="btn btn-danger pull-left" style="margin-bottom:2%;margin-left:2%;" href="http://localhost/bs/dashboard/c_tbng/penarikan" >Penarikan</a></span>
            </p>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>Rp. <?php echo $hasil->penarikan ?></td>
                    <td>Rp. <?php echo $hasil->setoran ?></td>
                    <td>Rp. <?php echo $hasil->saldo ?></td>
                    <td>
