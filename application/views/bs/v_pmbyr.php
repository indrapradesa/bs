      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="http://localhost/bs/dashboard/c_pmbyr"><i class="fa fa-circle-o text-yellow"></i>Pembayaran</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
           <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <p><a href="http://localhost/bs/dashboard/c_pmbyr/cetak" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
                <a href="http://localhost/bs/dashboard/c_excel/export_excel" target="_blank" class="btn btn-default"><i class="fa fa-file-excel-o"></i> Import Excel</a></p>
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><span class="label label-success"> <?php echo $hasil->p_status ?> </span></td>
                    <td>
                ...
                <tr>
                  <th></th>
                  <th></th>
                  <th class="bg-navy color-palette">Total Rincian :</th>
                  <th class="bg-navy color-palette">  <!-- Plastik -->
                    <?php
                  $sum = 0;
                  foreach($data_pmbyr as $row){
                   $sum += $row->plas;
                  }
