      ...
      <div class="row">
        <div class="col-xs-12">
           <div class="box">
            ...
            <form class="form-horizontal" action="<?php echo base_url('dashboard/c_tbng/simpanpenarikan') ?>" method="POST" onsubmit="return cek_nilai();">
                    <input type="hidden" name="id_abs" value="<?php echo $u->id ?>">
                <div class="form-group">
                  <label for="nama" class="col-sm-2 control-label">Nama</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="nama" name="nama" value="<?php echo $u->nama ?>" readonly>
                  </div>
                </div>
              <div class="form-group">
                  <label for="saldo" class="col-sm-2 control-label">Saldo</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="saldo" name="saldo" value="<?php echo $u->saldoo ?>" readonly id="saldo">
                  </div>
                </div>
              <div class="form-group">
              <label for="saldo" class="col-sm-2 control-label">Jumlah Penarikan</label>
                  <div class="col-sm-10">
                <input name="penarikan" type="text" class="form-control" placeholder="Masukkan Jumlah" id="penarikan">
              </div>
            </div>
                <div class="form-group">
  ...
  $(function () {
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $( "#nama" ).autocomplete({
              source: "<?php echo site_url('dashboard/c_tbng/get_autocomplete/?');?>"
            });
        });
    </script>
</body>
