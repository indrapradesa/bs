      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="http://localhost/bs/dashboard/c_angkut"><i class="fa fa-circle-o text-aqua"></i>Penggangkutan</a></li>
               ...
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><span class="label label-warning"><?php echo $hasil->status ?></span></td>
                  </tr>
