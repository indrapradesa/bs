      ...
      <div class="row">
        <div class="col-xs-12">
           <div class="box">
            ...
            <form class="form-horizontal" action="<?php echo base_url('dashboard/c_tbng/simpan') ?>" method="POST">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="saldo" name="saldo" value="<?php echo $u->saldoo ?>" readonly>
                  </div>
                </div>
              <div class="form-group">
              <label for="saldo" class="col-sm-2 control-label">Jumlah Setoran</label>
                  <div class="col-sm-10">
                <input name="setoran" type="number" min="1" class="form-control" placeholder="Masukkan Jumlah">
              </div>
            </div>
                <div class="form-group">
