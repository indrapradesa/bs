    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="http://localhost/bs/dashboard/c_abs"><i class="fa fa-circle-o text-aqua"></i>Anggota Bank Sampah</a></li>
               ...
               <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $hasil->j_tbng ?></td>
                    <td><?php echo $hasil->s_tbng ?></td>
                    <td>
                        <a href="" class="btn btn-sm btn-success">Edit</a>
                        <a class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-success">Hapus</a>
